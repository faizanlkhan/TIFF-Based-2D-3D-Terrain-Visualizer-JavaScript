...
A SaaS platform for generating **2D elevation maps**, **3D terrain surfaces**, **erosion-risk maps**, and **landform classifications** directly from **GeoTIFF DEM files** — all using **vanilla JavaScript**, Plotly, and GeoTIFF.js.
